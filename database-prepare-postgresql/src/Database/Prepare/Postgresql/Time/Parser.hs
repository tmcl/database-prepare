...
-- 1. module renamed (localisation to this project)
-- 2. {-# OPTIONS_GHC -Wwarn #-} (different defaults)
-- 3. import Data.Fixed (Fixed(MkFixed))
-- 4. definition of toPico (avoid another internal pg-s dependency)

module Database.Prepare.Postgresql.Time.Parser
    (
      day
    , localTime
    , timeOfDay
